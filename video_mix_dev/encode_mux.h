...
int write_one_video_frame(AVFormatContext *oc, OutputStream *ost, AVFrame* frame);
int write_one_audio_frame(AVFormatContext *oc, OutputStream *ost, AVFrame* frame);
